      ...
      <Section className="relative py-20">
        <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="relative h-72 md:h-96 rounded-2xl overflow-hidden ring-1 ring-white/10">
            <Image src="/images/editorial-1.jpg" alt="Intervention pneus" fill className="object-cover" />
          </div>
        </div>
      </Section>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="mt-10 grid lg:grid-cols-3 gap-6">
            {[
              ...
              { name: "Montage pneu (à l’unité)", price: "20€", items: ["Montage/valve", "Équilibrage"] },
